...
class TyCode_ms_Seller_SellerKernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'TyCode\\Seller\\Product\\Infrastructure\\Web\\GetProduct' => 'getGetProductService',
            'TyCode\\Seller\\Product\\Infrastructure\\Web\\GetProductByCriteria' => 'getGetProductByCriteriaService',
            'TyCode\\Seller\\Product\\Infrastructure\\Web\\GetProducts' => 'getGetProductsService',
            'TyCode\\Seller\\Product\\Infrastructure\\Web\\HealthCheckGetController' => 'getHealthCheckGetControllerService',
            'TyCode\\Seller\\Product\\Infrastructure\\Web\\ProductResponseMapper' => 'getProductResponseMapperService',
            'TyCode\\Seller\\Review\\Infrastructure\\Web\\HealthCheckGetController' => 'getHealthCheckGetController2Service',
            'TyCode\\Seller\\Review\\Infrastructure\\Web\\PostReviewCreate' => 'getPostReviewCreateService',
    ...
    /**
     * Gets the public 'TyCode\Seller\Product\Infrastructure\Web\GetProduct' shared autowired service.
     *
     * @return \TyCode\Seller\Product\Infrastructure\Web\GetProduct
     */
    protected static function getGetProductService($container)
    {
        include_once \dirname(__DIR__, 6).'/src/Seller/Product/Infrastructure/Web/GetProduct.php';

        return $container->services['TyCode\\Seller\\Product\\Infrastructure\\Web\\GetProduct'] = new \TyCode\Seller\Product\Infrastructure\Web\GetProduct();
    }

    /**
     * Gets the public 'TyCode\Seller\Product\Infrastructure\Web\GetProductByCriteria' shared autowired service.
     *
     * @return \TyCode\Seller\Product\Infrastructure\Web\GetProductByCriteria
     */
    protected static function getGetProductByCriteriaService($container)
    {
        include_once \dirname(__DIR__, 6).'/src/Seller/Product/Infrastructure/Web/GetProductByCriteria.php';

        return $container->services['TyCode\\Seller\\Product\\Infrastructure\\Web\\GetProductByCriteria'] = new \TyCode\Seller\Product\Infrastructure\Web\GetProductByCriteria();
    }

    /**
     * Gets the public 'TyCode\Seller\Product\Infrastructure\Web\GetProducts' shared autowired service.
     *
     * @return \TyCode\Seller\Product\Infrastructure\Web\GetProducts
     */
    protected static function getGetProductsService($container)
    {
        include_once \dirname(__DIR__, 6).'/src/Seller/Product/Infrastructure/Web/GetProducts.php';

        return $container->services['TyCode\\Seller\\Product\\Infrastructure\\Web\\GetProducts'] = new \TyCode\Seller\Product\Infrastructure\Web\GetProducts();
    }

    /**
     * Gets the public 'TyCode\Seller\Product\Infrastructure\Web\HealthCheckGetController' shared autowired service.
     *
     * @return \TyCode\Seller\Product\Infrastructure\Web\HealthCheckGetController
     */
    protected static function getHealthCheckGetControllerService($container)
    {
        include_once \dirname(__DIR__, 6).'/src/Seller/Product/Infrastructure/Web/HealthCheckGetController.php';

        return $container->services['TyCode\\Seller\\Product\\Infrastructure\\Web\\HealthCheckGetController'] = new \TyCode\Seller\Product\Infrastructure\Web\HealthCheckGetController();
    }

    /**
     * Gets the public 'TyCode\Seller\Product\Infrastructure\Web\ProductResponseMapper' shared autowired service.
     *
     * @return \TyCode\Seller\Product\Infrastructure\Web\ProductResponseMapper
     */
    protected static function getProductResponseMapperService($container)
    {
        include_once \dirname(__DIR__, 6).'/src/Seller/Product/Infrastructure/Web/ProductResponseMapper.php';

        return $container->services['TyCode\\Seller\\Product\\Infrastructure\\Web\\ProductResponseMapper'] = new \TyCode\Seller\Product\Infrastructure\Web\ProductResponseMapper();
    }

    /**
     * Gets the public 'TyCode\Seller\Review\Infrastructure\Web\HealthCheckGetController' shared autowired service.
     *
     * @return \TyCode\Seller\Review\Infrastructure\Web\HealthCheckGetController
     */
    protected static function getHealthCheckGetController2Service($container)
    {
        include_once \dirname(__DIR__, 6).'/src/Seller/Review/Infrastructure/Web/HealthCheckGetController.php';

        return $container->services['TyCode\\Seller\\Review\\Infrastructure\\Web\\HealthCheckGetController'] = new \TyCode\Seller\Review\Infrastructure\Web\HealthCheckGetController();
    }

    /**
     * Gets the public 'TyCode\Seller\Review\Infrastructure\Web\PostReviewCreate' shared autowired service.
     *
     * @return \TyCode\Seller\Review\Infrastructure\Web\PostReviewCreate
     */
    protected static function getPostReviewCreateService($container)
    {
        include_once \dirname(__DIR__, 6).'/src/Seller/Review/Infrastructure/Web/PostReviewCreate.php';

        return $container->services['TyCode\\Seller\\Review\\Infrastructure\\Web\\PostReviewCreate'] = new \TyCode\Seller\Review\Infrastructure\Web\PostReviewCreate();
    }
    ...
    protected static function getConsole_CommandLoaderService($container)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'TyCode\\Seller\\Review\\Infrastructure\\Cli\\RabbitMq\\ConfigureRabbitMqCommand' => ['privates', 'TyCode\\Seller\\Review\\Infrastructure\\Cli\\RabbitMq\\ConfigureRabbitMqCommand', 'getConfigureRabbitMqCommandService', false],
            'TyCode\\Seller\\Review\\Infrastructure\\Cli\\RabbitMq\\ConsumeRabbitMqEventsCommand' => ['privates', 'TyCode\\Seller\\Review\\Infrastructure\\Cli\\RabbitMq\\ConsumeRabbitMqEventsCommand', 'getConsumeRabbitMqEventsCommandService', false],
            'TyCode\\Seller\\Review\\Infrastructure\\Cli\\RabbitMq\\GenerateSupervisorRabbitMqConsumerFilesCommand' => ['privates', 'TyCode\\Seller\\Review\\Infrastructure\\Cli\\RabbitMq\\GenerateSupervisorRabbitMqConsumerFilesCommand', 'getGenerateSupervisorRabbitMqConsumerFilesCommandService', false],
            ...
            'TyCode\\Seller\\Review\\Infrastructure\\Cli\\RabbitMq\\ConfigureRabbitMqCommand' => 'TyCode\\Seller\\Review\\Infrastructure\\Cli\\RabbitMq\\ConfigureRabbitMqCommand',
            'TyCode\\Seller\\Review\\Infrastructure\\Cli\\RabbitMq\\ConsumeRabbitMqEventsCommand' => 'TyCode\\Seller\\Review\\Infrastructure\\Cli\\RabbitMq\\ConsumeRabbitMqEventsCommand',
            'TyCode\\Seller\\Review\\Infrastructure\\Cli\\RabbitMq\\GenerateSupervisorRabbitMqConsumerFilesCommand' => 'TyCode\\Seller\\Review\\Infrastructure\\Cli\\RabbitMq\\GenerateSupervisorRabbitMqConsumerFilesCommand',
    ...
    /**
     * Gets the private '.service_locator.Zbeqssn' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected static function get_ServiceLocator_ZbeqssnService($container)
    {
        return $container->privates['.service_locator.Zbeqssn'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'TyCode\\Seller\\Product\\Infrastructure\\Web\\GetProduct::__invoke' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\Seller\\Product\\Infrastructure\\Web\\GetProductByCriteria::__invoke' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\Seller\\Product\\Infrastructure\\Web\\GetProducts::__invoke' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\Seller\\Review\\Infrastructure\\Web\\PostReviewCreate::__invoke' => ['privates', '.service_locator.lwNoDbx', 'get_ServiceLocator_LwNoDbxService', false],
            ...
            'TyCode\\Seller\\Product\\Infrastructure\\Web\\GetProduct:__invoke' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\Seller\\Product\\Infrastructure\\Web\\GetProduct' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\Seller\\Product\\Infrastructure\\Web\\GetProductByCriteria:__invoke' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\Seller\\Product\\Infrastructure\\Web\\GetProductByCriteria' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\Seller\\Product\\Infrastructure\\Web\\GetProducts:__invoke' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\Seller\\Product\\Infrastructure\\Web\\GetProducts' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\Seller\\Review\\Infrastructure\\Web\\PostReviewCreate:__invoke' => ['privates', '.service_locator.lwNoDbx', 'get_ServiceLocator_LwNoDbxService', false],
            'TyCode\\Seller\\Review\\Infrastructure\\Web\\PostReviewCreate' => ['privates', '.service_locator.lwNoDbx', 'get_ServiceLocator_LwNoDbxService', false],
            'kernel:loadRoutes' => ['privates', '.service_locator.y4_Zrx.', 'get_ServiceLocator_Y4Zrx_Service', false],
            'kernel:registerContainerConfiguration' => ['privates', '.service_locator.y4_Zrx.', 'get_ServiceLocator_Y4Zrx_Service', false],
        ], [
            'TyCode\\Seller\\Product\\Infrastructure\\Web\\GetProduct::__invoke' => '?',
            'TyCode\\Seller\\Product\\Infrastructure\\Web\\GetProductByCriteria::__invoke' => '?',
            'TyCode\\Seller\\Product\\Infrastructure\\Web\\GetProducts::__invoke' => '?',
            'TyCode\\Seller\\Review\\Infrastructure\\Web\\PostReviewCreate::__invoke' => '?',
            'kernel::loadRoutes' => '?',
            'kernel::registerContainerConfiguration' => '?',
            'TyCode\\Seller\\Product\\Infrastructure\\Web\\GetProduct:__invoke' => '?',
            'TyCode\\Seller\\Product\\Infrastructure\\Web\\GetProduct' => '?',
            'TyCode\\Seller\\Product\\Infrastructure\\Web\\GetProductByCriteria:__invoke' => '?',
            'TyCode\\Seller\\Product\\Infrastructure\\Web\\GetProductByCriteria' => '?',
            'TyCode\\Seller\\Product\\Infrastructure\\Web\\GetProducts:__invoke' => '?',
            'TyCode\\Seller\\Product\\Infrastructure\\Web\\GetProducts' => '?',
            'TyCode\\Seller\\Review\\Infrastructure\\Web\\PostReviewCreate:__invoke' => '?',
            'TyCode\\Seller\\Review\\Infrastructure\\Web\\PostReviewCreate' => '?',
            'kernel:loadRoutes' => '?',
            'kernel:registerContainerConfiguration' => '?',
        ]);
    }
    ...
    /**
     * Gets the private 'TyCode\Seller\Review\Infrastructure\Cli\RabbitMq\ConfigureRabbitMqCommand' shared autowired service.
     *
     * @return \TyCode\Seller\Review\Infrastructure\Cli\RabbitMq\ConfigureRabbitMqCommand
     */
    protected static function getConfigureRabbitMqCommandService($container)
    {
        include_once \dirname(__DIR__, 6).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 6).'/src/Seller/Product/Infrastructure/Cli/RabbitMq/ConfigureRabbitMqCommand.php';
        include_once \dirname(__DIR__, 6).'/src/Shared/Infrsatructure/Bus/Event/RabbitMq/RabbitMqConfigurer.php';

        $container->privates['TyCode\\Seller\\Review\\Infrastructure\\Cli\\RabbitMq\\ConfigureRabbitMqCommand'] = $instance = new \TyCode\Seller\Review\Infrastructure\Cli\RabbitMq\ConfigureRabbitMqCommand(new \TyCode\Shared\Infrastructure\Bus\Event\RabbitMq\RabbitMqConfigurer(($container->privates['TyCode\\Shared\\Infrastructure\\Bus\\Event\\RabbitMq\\RabbitMqConnection'] ?? self::getRabbitMqConnectionService($container))), $container->getEnv('RABBITMQ_EXCHANGE'), new RewindableGenerator(function () use ($container) {
    ...
    /**
     * Gets the private 'TyCode\Seller\Review\Infrastructure\Cli\RabbitMq\ConsumeRabbitMqEventsCommand' shared autowired service.
     *
     * @return \TyCode\Seller\Review\Infrastructure\Cli\RabbitMq\ConsumeRabbitMqEventsCommand
     */
    protected static function getConsumeRabbitMqEventsCommandService($container)
    {
        include_once \dirname(__DIR__, 6).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 6).'/src/Seller/Product/Infrastructure/Cli/RabbitMq/ConsumeRabbitMqEventsCommand.php';
        ...
        $container->privates['TyCode\\Seller\\Review\\Infrastructure\\Cli\\RabbitMq\\ConsumeRabbitMqEventsCommand'] = $instance = new \TyCode\Seller\Review\Infrastructure\Cli\RabbitMq\ConsumeRabbitMqEventsCommand(new \TyCode\Shared\Infrastructure\Bus\Event\RabbitMq\RabbitMqEventsConsumer(($container->privates['TyCode\\Shared\\Infrastructure\\Bus\\Event\\RabbitMq\\RabbitMqConnection'] ?? self::getRabbitMqConnectionService($container)), new \TyCode\Shared\Infrastructure\Bus\Event\EventJsonDeserializer(new \TyCode\Shared\Infrastructure\Bus\Event\EventMapping(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['TyCode\\Seller\\Product\\Application\\Subscriber\\CreatedProductOn'] ?? self::getCreatedProductOnService($container));
            yield 1 => ($container->privates['TyCode\\Seller\\Product\\Application\\Subscriber\\DeliveredReviewOn'] ?? self::getDeliveredReviewOnService($container));
    ...
    /**
     * Gets the private 'TyCode\Seller\Review\Infrastructure\Cli\RabbitMq\GenerateSupervisorRabbitMqConsumerFilesCommand' shared autowired service.
     *
     * @return \TyCode\Seller\Review\Infrastructure\Cli\RabbitMq\GenerateSupervisorRabbitMqConsumerFilesCommand
     */
    protected static function getGenerateSupervisorRabbitMqConsumerFilesCommandService($container)
    {
        include_once \dirname(__DIR__, 6).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 6).'/src/Seller/Product/Infrastructure/Cli/RabbitMq/GenerateSupervisorRabbitMqConsumerFilesCommand.php';

        $container->privates['TyCode\\Seller\\Review\\Infrastructure\\Cli\\RabbitMq\\GenerateSupervisorRabbitMqConsumerFilesCommand'] = $instance = new \TyCode\Seller\Review\Infrastructure\Cli\RabbitMq\GenerateSupervisorRabbitMqConsumerFilesCommand(($container->privates['TyCode\\Shared\\Infrastructure\\Bus\\Event\\EventSubscriberLocator'] ?? self::getEventSubscriberLocatorService($container)));
