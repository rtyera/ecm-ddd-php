...
class TyCode_ms_Shop_ShopKernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'TyCode\\Shop\\Product\\Infrastructure\\Web\\GetProductByCriteriaCQRS' => 'getGetProductByCriteriaCQRSService',
    ...
    /**
     * Gets the public 'TyCode\Shop\Product\Infrastructure\Web\GetProductByCriteriaCQRS' shared autowired service.
     *
     * @return \TyCode\Shop\Product\Infrastructure\Web\GetProductByCriteriaCQRS
     */
    ...
    /**
     * Gets the public 'TyCode\Shop\Product\Infrastructure\Web\PostProductCreateCQRS' shared autowired service.
     *
     * @return \TyCode\Shop\Product\Infrastructure\Web\PostProductCreateCQRS
     */
    ...
    /**
     * Gets the public 'TyCode\Shop\Review\Infrastructure\Web\ReviewResponse' shared autowired service.
     *
     * @return \TyCode\Shop\Review\Infrastructure\Web\ReviewResponse
     */
    ...
    protected static function get_ServiceLocator_SS4YCfjService($container)
    {
        return $container->privates['.service_locator.SS4YCfj'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'TyCode\\Shop\\Product\\Infrastructure\\Web\\GetProduct:__invoke' => ['privates', '.service_locator.Fibiztl', 'get_ServiceLocator_FibiztlService', false],
            'TyCode\\Shop\\Product\\Infrastructure\\Web\\GetProduct' => ['privates', '.service_locator.Fibiztl', 'get_ServiceLocator_FibiztlService', false],
            'TyCode\\Shop\\Product\\Infrastructure\\Web\\GetProductByCriteria:__invoke' => ['privates', '.service_locator.aIPOfxe', 'get_ServiceLocator_AIPOfxeService', false],
            'TyCode\\Shop\\Product\\Infrastructure\\Web\\GetProductByCriteria' => ['privates', '.service_locator.aIPOfxe', 'get_ServiceLocator_AIPOfxeService', false],
            'TyCode\\Shop\\Product\\Infrastructure\\Web\\GetProductByCriteriaCQRS:__invoke' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\Shop\\Product\\Infrastructure\\Web\\GetProductByCriteriaCQRS' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\Shop\\Product\\Infrastructure\\Web\\GetProducts:__invoke' => ['privates', '.service_locator.Vw4xC8x', 'get_ServiceLocator_Vw4xC8xService', false],
            'TyCode\\Shop\\Product\\Infrastructure\\Web\\GetProducts' => ['privates', '.service_locator.Vw4xC8x', 'get_ServiceLocator_Vw4xC8xService', false],
            'TyCode\\Shop\\Product\\Infrastructure\\Web\\PostProductCreate:__invoke' => ['privates', '.service_locator.6Q6Yeh_', 'get_ServiceLocator_6Q6YehService', false],
            ...
            'TyCode\\Shop\\Product\\Infrastructure\\Web\\GetProductByCriteriaCQRS::__invoke' => '?',
            ...
            'TyCode\\Shop\\Product\\Infrastructure\\Web\\GetProductByCriteriaCQRS:__invoke' => '?',
            'TyCode\\Shop\\Product\\Infrastructure\\Web\\GetProductByCriteriaCQRS' => '?',
            'TyCode\\Shop\\Product\\Infrastructure\\Web\\GetProducts:__invoke' => '?',
