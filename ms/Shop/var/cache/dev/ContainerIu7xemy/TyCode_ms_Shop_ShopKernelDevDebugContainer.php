...
class TyCode_ms_Shop_ShopKernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'TyCode\\ms\\Shop\\Controller\\HealthCheckGetController' => 'getHealthCheckGetControllerService',
            'TyCode\\ms\\Shop\\Controller\\Product\\GetProduct' => 'getGetProductService',
            'TyCode\\ms\\Shop\\Controller\\Product\\GetProductByCriteria' => 'getGetProductByCriteriaService',
            'TyCode\\ms\\Shop\\Controller\\Product\\GetProducts' => 'getGetProductsService',
            'TyCode\\ms\\Shop\\Controller\\Product\\PostProductCreate' => 'getPostProductCreateService',
            'TyCode\\ms\\Shop\\Controller\\Review\\GetReviewByProductId' => 'getGetReviewByProductIdService',
            'TyCode\\ms\\Shop\\Controller\\Review\\GetReviewsByCriteria' => 'getGetReviewsByCriteriaService',
            'TyCode\\ms\\Shop\\Controller\\Review\\PutCheckerReview' => 'getPutCheckerReviewService',
    ...
    /**
     * Gets the public 'TyCode\ms\Shop\Controller\HealthCheckGetController' shared autowired service.
     *
     * @return \TyCode\ms\Shop\Controller\HealthCheckGetController
     */
    protected static function getHealthCheckGetControllerService($container)
    {
        ...
        return $container->services['TyCode\\ms\\Shop\\Controller\\HealthCheckGetController'] = new \TyCode\ms\Shop\Controller\HealthCheckGetController();
    }

    /**
     * Gets the public 'TyCode\ms\Shop\Controller\Product\GetProduct' shared autowired service.
     *
     * @return \TyCode\ms\Shop\Controller\Product\GetProduct
     */
    protected static function getGetProductService($container)
    {
        ...
        return $container->services['TyCode\\ms\\Shop\\Controller\\Product\\GetProduct'] = new \TyCode\ms\Shop\Controller\Product\GetProduct();
    }

    /**
     * Gets the public 'TyCode\ms\Shop\Controller\Product\GetProductByCriteria' shared autowired service.
     *
     * @return \TyCode\ms\Shop\Controller\Product\GetProductByCriteria
     */
    protected static function getGetProductByCriteriaService($container)
    {
        ...
        return $container->services['TyCode\\ms\\Shop\\Controller\\Product\\GetProductByCriteria'] = new \TyCode\ms\Shop\Controller\Product\GetProductByCriteria();
    }

    /**
     * Gets the public 'TyCode\ms\Shop\Controller\Product\GetProducts' shared autowired service.
     *
     * @return \TyCode\ms\Shop\Controller\Product\GetProducts
     */
    protected static function getGetProductsService($container)
    {
        ...
        return $container->services['TyCode\\ms\\Shop\\Controller\\Product\\GetProducts'] = new \TyCode\ms\Shop\Controller\Product\GetProducts();
    }

    /**
     * Gets the public 'TyCode\ms\Shop\Controller\Product\PostProductCreate' shared autowired service.
     *
     * @return \TyCode\ms\Shop\Controller\Product\PostProductCreate
     */
    protected static function getPostProductCreateService($container)
    {
        include_once \dirname(__DIR__, 4).'/src/Controller/Product/PostProductCreate.php';

        return $container->services['TyCode\\ms\\Shop\\Controller\\Product\\PostProductCreate'] = new \TyCode\ms\Shop\Controller\Product\PostProductCreate();
    }

    /**
     * Gets the public 'TyCode\ms\Shop\Controller\Review\GetReviewByProductId' shared autowired service.
     *
     * @return \TyCode\ms\Shop\Controller\Review\GetReviewByProductId
     */
    protected static function getGetReviewByProductIdService($container)
    {
        include_once \dirname(__DIR__, 4).'/src/Controller/Review/GetReviewByProductId.php';

        return $container->services['TyCode\\ms\\Shop\\Controller\\Review\\GetReviewByProductId'] = new \TyCode\ms\Shop\Controller\Review\GetReviewByProductId();
    }

    /**
     * Gets the public 'TyCode\ms\Shop\Controller\Review\GetReviewsByCriteria' shared autowired service.
     *
     * @return \TyCode\ms\Shop\Controller\Review\GetReviewsByCriteria
     */
    protected static function getGetReviewsByCriteriaService($container)
    {
        include_once \dirname(__DIR__, 4).'/src/Controller/Review/GetReviewsByCriteria.php';

        return $container->services['TyCode\\ms\\Shop\\Controller\\Review\\GetReviewsByCriteria'] = new \TyCode\ms\Shop\Controller\Review\GetReviewsByCriteria();
    }

    /**
     * Gets the public 'TyCode\ms\Shop\Controller\Review\PutCheckerReview' shared autowired service.
     *
     * @return \TyCode\ms\Shop\Controller\Review\PutCheckerReview
     */
    protected static function getPutCheckerReviewService($container)
    {
        include_once \dirname(__DIR__, 4).'/src/Controller/Review/PutCheckerReview.php';

        return $container->services['TyCode\\ms\\Shop\\Controller\\Review\\PutCheckerReview'] = new \TyCode\ms\Shop\Controller\Review\PutCheckerReview();
    }
    ...
    protected static function getConsole_CommandLoaderService($container)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'TyCode\\ms\\Shop\\Command\\RabbitMq\\ConfigureRabbitMqCommand' => ['privates', 'TyCode\\ms\\Shop\\Command\\RabbitMq\\ConfigureRabbitMqCommand', 'getConfigureRabbitMqCommandService', false],
            'TyCode\\ms\\Shop\\Command\\RabbitMq\\ConsumeRabbitMqEventsCommand' => ['privates', 'TyCode\\ms\\Shop\\Command\\RabbitMq\\ConsumeRabbitMqEventsCommand', 'getConsumeRabbitMqEventsCommandService', false],
            'TyCode\\ms\\Shop\\Command\\RabbitMq\\GenerateSupervisorRabbitMqConsumerFilesCommand' => ['privates', 'TyCode\\ms\\Shop\\Command\\RabbitMq\\GenerateSupervisorRabbitMqConsumerFilesCommand', 'getGenerateSupervisorRabbitMqConsumerFilesCommandService', false],
            ...
            'TyCode\\ms\\Shop\\Command\\RabbitMq\\ConfigureRabbitMqCommand' => 'TyCode\\ms\\Shop\\Command\\RabbitMq\\ConfigureRabbitMqCommand',
            'TyCode\\ms\\Shop\\Command\\RabbitMq\\ConsumeRabbitMqEventsCommand' => 'TyCode\\ms\\Shop\\Command\\RabbitMq\\ConsumeRabbitMqEventsCommand',
            'TyCode\\ms\\Shop\\Command\\RabbitMq\\GenerateSupervisorRabbitMqConsumerFilesCommand' => 'TyCode\\ms\\Shop\\Command\\RabbitMq\\GenerateSupervisorRabbitMqConsumerFilesCommand',
    ...
    /**
     * Gets the private '.service_locator.UbS00SA' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected static function get_ServiceLocator_UbS00SAService($container)
    {
        return $container->privates['.service_locator.UbS00SA'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'TyCode\\ms\\Shop\\Controller\\Product\\GetProduct::__invoke' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\ms\\Shop\\Controller\\Product\\GetProductByCriteria::__invoke' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\ms\\Shop\\Controller\\Product\\GetProducts::__invoke' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\ms\\Shop\\Controller\\Product\\PostProductCreate::__invoke' => ['privates', '.service_locator.lwNoDbx', 'get_ServiceLocator_LwNoDbxService', false],
            'TyCode\\ms\\Shop\\Controller\\Review\\GetReviewByProductId::__invoke' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\ms\\Shop\\Controller\\Review\\GetReviewsByCriteria::__invoke' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\ms\\Shop\\Controller\\Review\\PutCheckerReview::__invoke' => ['privates', '.service_locator.lwNoDbx', 'get_ServiceLocator_LwNoDbxService', false],
            ...
            'TyCode\\ms\\Shop\\Controller\\Product\\GetProduct:__invoke' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\ms\\Shop\\Controller\\Product\\GetProduct' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\ms\\Shop\\Controller\\Product\\GetProductByCriteria:__invoke' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\ms\\Shop\\Controller\\Product\\GetProductByCriteria' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\ms\\Shop\\Controller\\Product\\GetProducts:__invoke' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\ms\\Shop\\Controller\\Product\\GetProducts' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\ms\\Shop\\Controller\\Product\\PostProductCreate:__invoke' => ['privates', '.service_locator.lwNoDbx', 'get_ServiceLocator_LwNoDbxService', false],
            'TyCode\\ms\\Shop\\Controller\\Product\\PostProductCreate' => ['privates', '.service_locator.lwNoDbx', 'get_ServiceLocator_LwNoDbxService', false],
            'TyCode\\ms\\Shop\\Controller\\Review\\GetReviewByProductId:__invoke' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\ms\\Shop\\Controller\\Review\\GetReviewByProductId' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\ms\\Shop\\Controller\\Review\\GetReviewsByCriteria:__invoke' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\ms\\Shop\\Controller\\Review\\GetReviewsByCriteria' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\ms\\Shop\\Controller\\Review\\PutCheckerReview:__invoke' => ['privates', '.service_locator.lwNoDbx', 'get_ServiceLocator_LwNoDbxService', false],
            'TyCode\\ms\\Shop\\Controller\\Review\\PutCheckerReview' => ['privates', '.service_locator.lwNoDbx', 'get_ServiceLocator_LwNoDbxService', false],
            'kernel:loadRoutes' => ['privates', '.service_locator.y4_Zrx.', 'get_ServiceLocator_Y4Zrx_Service', false],
            'kernel:registerContainerConfiguration' => ['privates', '.service_locator.y4_Zrx.', 'get_ServiceLocator_Y4Zrx_Service', false],
        ], [
            'TyCode\\ms\\Shop\\Controller\\Product\\GetProduct::__invoke' => '?',
            'TyCode\\ms\\Shop\\Controller\\Product\\GetProductByCriteria::__invoke' => '?',
            'TyCode\\ms\\Shop\\Controller\\Product\\GetProducts::__invoke' => '?',
            'TyCode\\ms\\Shop\\Controller\\Product\\PostProductCreate::__invoke' => '?',
            'TyCode\\ms\\Shop\\Controller\\Review\\GetReviewByProductId::__invoke' => '?',
            'TyCode\\ms\\Shop\\Controller\\Review\\GetReviewsByCriteria::__invoke' => '?',
            'TyCode\\ms\\Shop\\Controller\\Review\\PutCheckerReview::__invoke' => '?',
            'kernel::loadRoutes' => '?',
            'kernel::registerContainerConfiguration' => '?',
            'TyCode\\ms\\Shop\\Controller\\Product\\GetProduct:__invoke' => '?',
            'TyCode\\ms\\Shop\\Controller\\Product\\GetProduct' => '?',
            'TyCode\\ms\\Shop\\Controller\\Product\\GetProductByCriteria:__invoke' => '?',
            'TyCode\\ms\\Shop\\Controller\\Product\\GetProductByCriteria' => '?',
            'TyCode\\ms\\Shop\\Controller\\Product\\GetProducts:__invoke' => '?',
            'TyCode\\ms\\Shop\\Controller\\Product\\GetProducts' => '?',
            'TyCode\\ms\\Shop\\Controller\\Product\\PostProductCreate:__invoke' => '?',
            'TyCode\\ms\\Shop\\Controller\\Product\\PostProductCreate' => '?',
            'TyCode\\ms\\Shop\\Controller\\Review\\GetReviewByProductId:__invoke' => '?',
            'TyCode\\ms\\Shop\\Controller\\Review\\GetReviewByProductId' => '?',
            'TyCode\\ms\\Shop\\Controller\\Review\\GetReviewsByCriteria:__invoke' => '?',
            'TyCode\\ms\\Shop\\Controller\\Review\\GetReviewsByCriteria' => '?',
            'TyCode\\ms\\Shop\\Controller\\Review\\PutCheckerReview:__invoke' => '?',
            'TyCode\\ms\\Shop\\Controller\\Review\\PutCheckerReview' => '?',
            'kernel:loadRoutes' => '?',
            'kernel:registerContainerConfiguration' => '?',
        ]);
    }
    ...
    protected static function getSymfonyMessageCommandBusService($container)
    {
        ...
        return $container->privates['TyCode\\Shared\\Infrastructure\\Bus\\Command\\SymfonyMessageCommandBus'] = new \TyCode\Shared\Infrastructure\Bus\Command\SymfonyMessageCommandBus(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['TyCode\\Shop\\Product\\Application\\Create\\CreateProductCommandHandler'] ?? self::getCreateProductCommandHandlerService($container));
            yield 1 => ($container->privates['TyCode\\Shop\\Review\\Application\\Checker\\CheckerReviewCommandHandler'] ?? self::getCheckerReviewCommandHandlerService($container));
            yield 2 => ($container->privates['TyCode\\Shop\\Review\\Application\\Create\\CreateReviewCommandHandler'] ?? self::getCreateReviewCommandHandlerService($container));
        }, 3));
    }
    ...
    protected static function getEventSubscriberLocatorService($container)
    {
        ...
        return $container->privates['TyCode\\Shared\\Infrastructure\\Bus\\Event\\EventSubscriberLocator'] = new \TyCode\Shared\Infrastructure\Bus\Event\EventSubscriberLocator(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['TyCode\\Shop\\Review\\Application\\Subscriber\\CreateReviewOn'] ?? self::getCreateReviewOnService($container));
        }, 1));
    }
    ...
    /**
     * Gets the private 'TyCode\Shared\Infrastructure\Bus\Event\RabbitMq\RabbitMqEventBus' shared autowired service.
     *
     * @return \TyCode\Shared\Infrastructure\Bus\Event\RabbitMq\RabbitMqEventBus
     */
    protected static function getRabbitMqEventBusService($container)
    {
    ...
    protected static function getSymfonyMessageQueryBusService($container)
    {
        ...
        return $container->privates['TyCode\\Shared\\Infrastructure\\Bus\\Query\\SymfonyMessageQueryBus'] = new \TyCode\Shared\Infrastructure\Bus\Query\SymfonyMessageQueryBus(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['TyCode\\Shop\\Product\\Application\\FindAll\\FindProductsQueryHandler'] ?? self::getFindProductsQueryHandlerService($container));
            yield 1 => ($container->privates['TyCode\\Shop\\Product\\Application\\FindByCriteria\\FindProductByCriteriaQueryHandler'] ?? self::getFindProductByCriteriaQueryHandlerService($container));
            yield 2 => ($container->privates['TyCode\\Shop\\Product\\Application\\FindById\\FindProductQueryHandler'] ?? self::getFindProductQueryHandlerService($container));
            yield 3 => ($container->privates['TyCode\\Shop\\Review\\Application\\FindByCriteria\\FindReviewsByCriteriaQueryHandler'] ?? self::getFindReviewsByCriteriaQueryHandlerService($container));
            yield 4 => ($container->privates['TyCode\\Shop\\Review\\Application\\FindByProductId\\FindReviewsByProductIdQueryHandler'] ?? self::getFindReviewsByProductIdQueryHandlerService($container));
        }, 5));
    }

    /**
     * Gets the private 'TyCode\Shop\Product\Application\Create\CreateProductCommandHandler' shared autowired service.
     *
     * @return \TyCode\Shop\Product\Application\Create\CreateProductCommandHandler
     */
    protected static function getCreateProductCommandHandlerService($container)
    {
        ...
        include_once \dirname(__DIR__, 6).'/src/Shop/Product/Application/Create/CreateProductCommandHandler.php';
        include_once \dirname(__DIR__, 6).'/src/Shop/Product/Application/Create/ProductCreator.php';

        return $container->privates['TyCode\\Shop\\Product\\Application\\Create\\CreateProductCommandHandler'] = new \TyCode\Shop\Product\Application\Create\CreateProductCommandHandler(new \TyCode\Shop\Product\Application\Create\ProductCreator(($container->privates['TyCode\\Shop\\Product\\Infrastructure\\Persistence\\DoctrineProductRepository'] ?? self::getDoctrineProductRepositoryService($container)), ($container->privates['TyCode\\Shared\\Infrastructure\\Bus\\Event\\RabbitMq\\RabbitMqEventBus'] ?? self::getRabbitMqEventBusService($container))));
    }

    /**
     * Gets the private 'TyCode\Shop\Product\Application\FindAll\FindProductsQueryHandler' shared autowired service.
     *
     * @return \TyCode\Shop\Product\Application\FindAll\FindProductsQueryHandler
     */
    protected static function getFindProductsQueryHandlerService($container)
    {
        ...
        include_once \dirname(__DIR__, 6).'/src/Shop/Product/Application/FindAll/FindProductsQueryHandler.php';
        include_once \dirname(__DIR__, 6).'/src/Shop/Product/Application/FindAll/ProductFinderAll.php';

        return $container->privates['TyCode\\Shop\\Product\\Application\\FindAll\\FindProductsQueryHandler'] = new \TyCode\Shop\Product\Application\FindAll\FindProductsQueryHandler(new \TyCode\Shop\Product\Application\FindAll\ProductFinderAll(($container->privates['TyCode\\Shop\\Product\\Infrastructure\\Persistence\\DoctrineProductRepository'] ?? self::getDoctrineProductRepositoryService($container))));
    }

    /**
     * Gets the private 'TyCode\Shop\Product\Application\FindByCriteria\FindProductByCriteriaQueryHandler' shared autowired service.
     *
     * @return \TyCode\Shop\Product\Application\FindByCriteria\FindProductByCriteriaQueryHandler
     */
    protected static function getFindProductByCriteriaQueryHandlerService($container)
    {
        include_once \dirname(__DIR__, 6).'/src/Shared/Domain/Bus/Query/QueryHandler.php';
        include_once \dirname(__DIR__, 6).'/src/Shop/Product/Application/FindByCriteria/FindProductByCriteriaQueryHandler.php';
        include_once \dirname(__DIR__, 6).'/src/Shop/Product/Application/FindByCriteria/ProductFinderByCriteria.php';

        return $container->privates['TyCode\\Shop\\Product\\Application\\FindByCriteria\\FindProductByCriteriaQueryHandler'] = new \TyCode\Shop\Product\Application\FindByCriteria\FindProductByCriteriaQueryHandler(new \TyCode\Shop\Product\Application\FindByCriteria\ProductFinderByCriteria(($container->privates['TyCode\\Shop\\Product\\Infrastructure\\Persistence\\DoctrineProductRepository'] ?? self::getDoctrineProductRepositoryService($container))));
    }

    /**
     * Gets the private 'TyCode\Shop\Product\Application\FindById\FindProductQueryHandler' shared autowired service.
     *
     * @return \TyCode\Shop\Product\Application\FindById\FindProductQueryHandler
     */
    protected static function getFindProductQueryHandlerService($container)
    {
        include_once \dirname(__DIR__, 6).'/src/Shared/Domain/Bus/Query/QueryHandler.php';
        include_once \dirname(__DIR__, 6).'/src/Shop/Product/Application/FindById/FindProductQueryHandler.php';
        include_once \dirname(__DIR__, 6).'/src/Shop/Product/Application/FindById/ProductFinderId.php';

        return $container->privates['TyCode\\Shop\\Product\\Application\\FindById\\FindProductQueryHandler'] = new \TyCode\Shop\Product\Application\FindById\FindProductQueryHandler(new \TyCode\Shop\Product\Application\FindById\ProductFinderId(($container->privates['TyCode\\Shop\\Product\\Infrastructure\\Persistence\\DoctrineProductRepository'] ?? self::getDoctrineProductRepositoryService($container))));
    }
    ...
    /**
     * Gets the private 'TyCode\Shop\Review\Application\Checker\CheckerReviewCommandHandler' shared autowired service.
     *
     * @return \TyCode\Shop\Review\Application\Checker\CheckerReviewCommandHandler
     */
    protected static function getCheckerReviewCommandHandlerService($container)
    {
        include_once \dirname(__DIR__, 6).'/src/Shared/Domain/Bus/Command/CommandHandler.php';
        include_once \dirname(__DIR__, 6).'/src/Shop/Review/Application/Checker/CheckerReviewCommandHandler.php';
        include_once \dirname(__DIR__, 6).'/src/Shop/Review/Application/Checker/ReviewChecker.php';
        include_once \dirname(__DIR__, 6).'/src/Shop/Review/Application/FindById/ReviewFindById.php';

        $a = ($container->privates['TyCode\\Shop\\Review\\Infrastructure\\Persistence\\DoctrineProductReviewRepository'] ?? self::getDoctrineProductReviewRepositoryService($container));

        return $container->privates['TyCode\\Shop\\Review\\Application\\Checker\\CheckerReviewCommandHandler'] = new \TyCode\Shop\Review\Application\Checker\CheckerReviewCommandHandler(new \TyCode\Shop\Review\Application\Checker\ReviewChecker(($container->privates['TyCode\\Shared\\Infrastructure\\Bus\\Event\\RabbitMq\\RabbitMqEventBus'] ?? self::getRabbitMqEventBusService($container)), $a, new \TyCode\Shop\Review\Application\FindById\ReviewFindById($a)));
    }

    /**
     * Gets the private 'TyCode\Shop\Review\Application\Create\CreateReviewCommandHandler' shared autowired service.
     *
     * @return \TyCode\Shop\Review\Application\Create\CreateReviewCommandHandler
     */
    protected static function getCreateReviewCommandHandlerService($container)
    {
        include_once \dirname(__DIR__, 6).'/src/Shared/Domain/Bus/Command/CommandHandler.php';
        include_once \dirname(__DIR__, 6).'/src/Shop/Review/Application/Create/CreateReviewCommandHandler.php';
        include_once \dirname(__DIR__, 6).'/src/Shop/Review/Application/Create/ReviewCreator.php';

        return $container->privates['TyCode\\Shop\\Review\\Application\\Create\\CreateReviewCommandHandler'] = new \TyCode\Shop\Review\Application\Create\CreateReviewCommandHandler(($container->privates['TyCode\\Shared\\Infrastructure\\Bus\\Event\\RabbitMq\\RabbitMqEventBus'] ?? self::getRabbitMqEventBusService($container)), new \TyCode\Shop\Review\Application\Create\ReviewCreator(($container->privates['TyCode\\Shop\\Review\\Infrastructure\\Persistence\\DoctrineProductReviewRepository'] ?? self::getDoctrineProductReviewRepositoryService($container))));
    }

    /**
     * Gets the private 'TyCode\Shop\Review\Application\FindByCriteria\FindReviewsByCriteriaQueryHandler' shared autowired service.
     *
     * @return \TyCode\Shop\Review\Application\FindByCriteria\FindReviewsByCriteriaQueryHandler
     */
    protected static function getFindReviewsByCriteriaQueryHandlerService($container)
    {
        include_once \dirname(__DIR__, 6).'/src/Shared/Domain/Bus/Query/QueryHandler.php';
        include_once \dirname(__DIR__, 6).'/src/Shop/Review/Application/FindByCriteria/FindReviewsByCriteriaQueryHandler.php';
        include_once \dirname(__DIR__, 6).'/src/Shop/Review/Application/FindByCriteria/ReviewFinderByCriteria.php';

        return $container->privates['TyCode\\Shop\\Review\\Application\\FindByCriteria\\FindReviewsByCriteriaQueryHandler'] = new \TyCode\Shop\Review\Application\FindByCriteria\FindReviewsByCriteriaQueryHandler(new \TyCode\Shop\Review\Application\FindByCriteria\ReviewFinderByCriteria(($container->privates['TyCode\\Shop\\Review\\Infrastructure\\Persistence\\DoctrineProductReviewRepository'] ?? self::getDoctrineProductReviewRepositoryService($container))));
    }

    /**
     * Gets the private 'TyCode\Shop\Review\Application\FindByProductId\FindReviewsByProductIdQueryHandler' shared autowired service.
     *
     * @return \TyCode\Shop\Review\Application\FindByProductId\FindReviewsByProductIdQueryHandler
     */
    protected static function getFindReviewsByProductIdQueryHandlerService($container)
    {
        include_once \dirname(__DIR__, 6).'/src/Shared/Domain/Bus/Query/QueryHandler.php';
        include_once \dirname(__DIR__, 6).'/src/Shop/Review/Application/FindByProductId/FindReviewsByProductIdQueryHandler.php';
        include_once \dirname(__DIR__, 6).'/src/Shop/Review/Application/FindByProductId/ReviewFinderProductId.php';

        return $container->privates['TyCode\\Shop\\Review\\Application\\FindByProductId\\FindReviewsByProductIdQueryHandler'] = new \TyCode\Shop\Review\Application\FindByProductId\FindReviewsByProductIdQueryHandler(new \TyCode\Shop\Review\Application\FindByProductId\ReviewFinderProductId(($container->privates['TyCode\\Shop\\Review\\Infrastructure\\Persistence\\DoctrineProductReviewRepository'] ?? self::getDoctrineProductReviewRepositoryService($container))));
    }

    /**
     * Gets the private 'TyCode\Shop\Review\Application\Subscriber\CreateReviewOn' shared autowired service.
     *
     * @return \TyCode\Shop\Review\Application\Subscriber\CreateReviewOn
     */
    protected static function getCreateReviewOnService($container)
    {
        include_once \dirname(__DIR__, 6).'/src/Shared/Domain/Bus/Event/EventSubscriber.php';
        include_once \dirname(__DIR__, 6).'/src/Shop/Review/Application/Subscriber/CreateReviewOn.php';

        return $container->privates['TyCode\\Shop\\Review\\Application\\Subscriber\\CreateReviewOn'] = new \TyCode\Shop\Review\Application\Subscriber\CreateReviewOn(($container->privates['TyCode\\Shared\\Infrastructure\\Bus\\Command\\SymfonyMessageCommandBus'] ?? self::getSymfonyMessageCommandBusService($container)));
    }

    /**
     * Gets the private 'TyCode\Shop\Review\Infrastructure\Persistence\DoctrineProductReviewRepository' shared autowired service.
     *
     * @return \TyCode\Shop\Review\Infrastructure\Persistence\DoctrineProductReviewRepository
     */
    protected static function getDoctrineProductReviewRepositoryService($container)
    {
        include_once \dirname(__DIR__, 6).'/src/Shop/Review/Domain/ReviewRepository.php';
        include_once \dirname(__DIR__, 6).'/src/Shop/Review/Infrastructure/Persistence/DoctrineProductReviewRepository.php';

        return $container->privates['TyCode\\Shop\\Review\\Infrastructure\\Persistence\\DoctrineProductReviewRepository'] = new \TyCode\Shop\Review\Infrastructure\Persistence\DoctrineProductReviewRepository(($container->services['Doctrine\\ORM\\EntityManager'] ?? self::getEntityManagerService($container)));
    }

    /**
     * Gets the private 'TyCode\ms\Shop\Command\RabbitMq\ConfigureRabbitMqCommand' shared autowired service.
     *
     * @return \TyCode\ms\Shop\Command\RabbitMq\ConfigureRabbitMqCommand
     */
    protected static function getConfigureRabbitMqCommandService($container)
    {
        ...
        $container->privates['TyCode\\ms\\Shop\\Command\\RabbitMq\\ConfigureRabbitMqCommand'] = $instance = new \TyCode\ms\Shop\Command\RabbitMq\ConfigureRabbitMqCommand(new \TyCode\Shared\Infrastructure\Bus\Event\RabbitMq\RabbitMqConfigurer(($container->privates['TyCode\\Shared\\Infrastructure\\Bus\\Event\\RabbitMq\\RabbitMqConnection'] ?? self::getRabbitMqConnectionService($container))), $container->getEnv('RABBITMQ_EXCHANGE'), new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['TyCode\\Shop\\Review\\Application\\Subscriber\\CreateReviewOn'] ?? self::getCreateReviewOnService($container));
        }, 1));

        $instance->setName('ecm:shop:rabbitmq:configure');

        return $instance;
    }

    /**
     * Gets the private 'TyCode\ms\Shop\Command\RabbitMq\ConsumeRabbitMqEventsCommand' shared autowired service.
     *
     * @return \TyCode\ms\Shop\Command\RabbitMq\ConsumeRabbitMqEventsCommand
     */
    protected static function getConsumeRabbitMqEventsCommandService($container)
    {
        ...
        $container->privates['TyCode\\ms\\Shop\\Command\\RabbitMq\\ConsumeRabbitMqEventsCommand'] = $instance = new \TyCode\ms\Shop\Command\RabbitMq\ConsumeRabbitMqEventsCommand(new \TyCode\Shared\Infrastructure\Bus\Event\RabbitMq\RabbitMqEventsConsumer(($container->privates['TyCode\\Shared\\Infrastructure\\Bus\\Event\\RabbitMq\\RabbitMqConnection'] ?? self::getRabbitMqConnectionService($container)), new \TyCode\Shared\Infrastructure\Bus\Event\EventJsonDeserializer(new \TyCode\Shared\Infrastructure\Bus\Event\EventMapping(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['TyCode\\Shop\\Review\\Application\\Subscriber\\CreateReviewOn'] ?? self::getCreateReviewOnService($container));
        ...
        $instance->setName('ecm:shop:rabbitmq:events:consume');

        return $instance;
    }

    /**
     * Gets the private 'TyCode\ms\Shop\Command\RabbitMq\GenerateSupervisorRabbitMqConsumerFilesCommand' shared autowired service.
     *
     * @return \TyCode\ms\Shop\Command\RabbitMq\GenerateSupervisorRabbitMqConsumerFilesCommand
     */
    protected static function getGenerateSupervisorRabbitMqConsumerFilesCommandService($container)
    {
        ...
        $container->privates['TyCode\\ms\\Shop\\Command\\RabbitMq\\GenerateSupervisorRabbitMqConsumerFilesCommand'] = $instance = new \TyCode\ms\Shop\Command\RabbitMq\GenerateSupervisorRabbitMqConsumerFilesCommand(($container->privates['TyCode\\Shared\\Infrastructure\\Bus\\Event\\EventSubscriberLocator'] ?? self::getEventSubscriberLocatorService($container)));

        $instance->setName('ecm:shop:rabbitmq:events:generate-supervisor-files');
