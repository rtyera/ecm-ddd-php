 ...
 */
class TyCode_ms_Product_ProductKernelDevDebugContainer extends Container
{
    protected $targetDir;
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'TyCode\\Product\\Infrastructure\\Web\\HealthCheck\\HealthCheckGetController' => 'getHealthCheckGetControllerService',
            'TyCode\\Product\\Infrastructure\\Web\\ProductResponse' => 'getProductResponseService',
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProduct' => 'getGetProductService',
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProductByCriteria' => 'getGetProductByCriteriaService',
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProductByCriteriaCQRS' => 'getGetProductByCriteriaCQRSService',
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProducts' => 'getGetProductsService',
            'TyCode\\Product\\Infrastructure\\Web\\Product\\PostProductCreate' => 'getPostProductCreateService',
            'TyCode\\Product\\Infrastructure\\Web\\Product\\PostProductCreateCQRS' => 'getPostProductCreateCQRSService',
    ...
    protected static function getEntityManagerService($container)
    {
        ...
        include_once \dirname(__DIR__, 6).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Product'.\DIRECTORY_SEPARATOR.'Shared'.\DIRECTORY_SEPARATOR.'Infrastructure'.\DIRECTORY_SEPARATOR.'Doctrine'.\DIRECTORY_SEPARATOR.'ProductEntityManagerFactory.php';

        return $container->services['Doctrine\\ORM\\EntityManager'] = \TyCode\Product\Shared\Infrastructure\Doctrine\ProductEntityManagerFactory::create(['driver' => $container->getEnv('PRODUCT_DATABASE_DRIVER'), 'host' => $container->getEnv('PRODUCT_DATABASE_HOST'), 'port' => $container->getEnv('PRODUCT_DATABASE_PORT'), 'dbname' => $container->getEnv('PRODUCT_DATABASE_NAME'), 'user' => $container->getEnv('PRODUCT_DATABASE_USER'), 'password' => $container->getEnv('PRODUCT_DATABASE_PASSWORD')], $container->getEnv('APP_ENV'));
    }
    ...
    /**
     * Gets the public 'TyCode\Product\Infrastructure\Web\HealthCheck\HealthCheckGetController' shared autowired service.
     *
     * @return \TyCode\Product\Infrastructure\Web\HealthCheck\HealthCheckGetController
     */
    protected static function getHealthCheckGetControllerService($container)
    {
        include_once \dirname(__DIR__, 6).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Product'.\DIRECTORY_SEPARATOR.'Infrastructure'.\DIRECTORY_SEPARATOR.'Web'.\DIRECTORY_SEPARATOR.'HealthCheck'.\DIRECTORY_SEPARATOR.'HealthCheckGetController.php';

        return $container->services['TyCode\\Product\\Infrastructure\\Web\\HealthCheck\\HealthCheckGetController'] = new \TyCode\Product\Infrastructure\Web\HealthCheck\HealthCheckGetController();
    }

    /**
     * Gets the public 'TyCode\Product\Infrastructure\Web\ProductResponse' shared autowired service.
     *
     * @return \TyCode\Product\Infrastructure\Web\ProductResponse
     */
    protected static function getProductResponseService($container)
    {
        include_once \dirname(__DIR__, 6).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Product'.\DIRECTORY_SEPARATOR.'Infrastructure'.\DIRECTORY_SEPARATOR.'Web'.\DIRECTORY_SEPARATOR.'ProductResponse.php';

        return $container->services['TyCode\\Product\\Infrastructure\\Web\\ProductResponse'] = new \TyCode\Product\Infrastructure\Web\ProductResponse();
    }

    /**
     * Gets the public 'TyCode\Product\Infrastructure\Web\Product\GetProduct' shared autowired service.
     *
     * @return \TyCode\Product\Infrastructure\Web\Product\GetProduct
     */
    protected static function getGetProductService($container)
    {
        include_once \dirname(__DIR__, 6).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Product'.\DIRECTORY_SEPARATOR.'Infrastructure'.\DIRECTORY_SEPARATOR.'Web'.\DIRECTORY_SEPARATOR.'Product'.\DIRECTORY_SEPARATOR.'GetProduct.php';

        return $container->services['TyCode\\Product\\Infrastructure\\Web\\Product\\GetProduct'] = new \TyCode\Product\Infrastructure\Web\Product\GetProduct();
    }

    /**
     * Gets the public 'TyCode\Product\Infrastructure\Web\Product\GetProductByCriteria' shared autowired service.
     *
     * @return \TyCode\Product\Infrastructure\Web\Product\GetProductByCriteria
     */
    protected static function getGetProductByCriteriaService($container)
    {
        include_once \dirname(__DIR__, 6).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Product'.\DIRECTORY_SEPARATOR.'Infrastructure'.\DIRECTORY_SEPARATOR.'Web'.\DIRECTORY_SEPARATOR.'Product'.\DIRECTORY_SEPARATOR.'GetProductByCriteria.php';

        return $container->services['TyCode\\Product\\Infrastructure\\Web\\Product\\GetProductByCriteria'] = new \TyCode\Product\Infrastructure\Web\Product\GetProductByCriteria();
    }

    /**
     * Gets the public 'TyCode\Product\Infrastructure\Web\Product\GetProductByCriteriaCQRS' shared autowired service.
     *
     * @return \TyCode\Product\Infrastructure\Web\Product\GetProductByCriteriaCQRS
     */
    protected static function getGetProductByCriteriaCQRSService($container)
    {
        include_once \dirname(__DIR__, 6).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Product'.\DIRECTORY_SEPARATOR.'Infrastructure'.\DIRECTORY_SEPARATOR.'Web'.\DIRECTORY_SEPARATOR.'Product'.\DIRECTORY_SEPARATOR.'GetProductByCriteriaCQRS.php';

        return $container->services['TyCode\\Product\\Infrastructure\\Web\\Product\\GetProductByCriteriaCQRS'] = new \TyCode\Product\Infrastructure\Web\Product\GetProductByCriteriaCQRS();
    }

    /**
     * Gets the public 'TyCode\Product\Infrastructure\Web\Product\GetProducts' shared autowired service.
     *
     * @return \TyCode\Product\Infrastructure\Web\Product\GetProducts
     */
    protected static function getGetProductsService($container)
    {
        include_once \dirname(__DIR__, 6).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Product'.\DIRECTORY_SEPARATOR.'Infrastructure'.\DIRECTORY_SEPARATOR.'Web'.\DIRECTORY_SEPARATOR.'Product'.\DIRECTORY_SEPARATOR.'GetProducts.php';

        return $container->services['TyCode\\Product\\Infrastructure\\Web\\Product\\GetProducts'] = new \TyCode\Product\Infrastructure\Web\Product\GetProducts();
    }

    /**
     * Gets the public 'TyCode\Product\Infrastructure\Web\Product\PostProductCreate' shared autowired service.
     *
     * @return \TyCode\Product\Infrastructure\Web\Product\PostProductCreate
     */
    protected static function getPostProductCreateService($container)
    {
        include_once \dirname(__DIR__, 6).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Product'.\DIRECTORY_SEPARATOR.'Infrastructure'.\DIRECTORY_SEPARATOR.'Web'.\DIRECTORY_SEPARATOR.'Product'.\DIRECTORY_SEPARATOR.'PostProductCreate.php';

        return $container->services['TyCode\\Product\\Infrastructure\\Web\\Product\\PostProductCreate'] = new \TyCode\Product\Infrastructure\Web\Product\PostProductCreate();
    }

    /**
     * Gets the public 'TyCode\Product\Infrastructure\Web\Product\PostProductCreateCQRS' shared autowired service.
     *
     * @return \TyCode\Product\Infrastructure\Web\Product\PostProductCreateCQRS
     */
    protected static function getPostProductCreateCQRSService($container)
    {
        include_once \dirname(__DIR__, 6).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Product'.\DIRECTORY_SEPARATOR.'Infrastructure'.\DIRECTORY_SEPARATOR.'Web'.\DIRECTORY_SEPARATOR.'Product'.\DIRECTORY_SEPARATOR.'PostProductCreateCQRS.php';

        return $container->services['TyCode\\Product\\Infrastructure\\Web\\Product\\PostProductCreateCQRS'] = new \TyCode\Product\Infrastructure\Web\Product\PostProductCreateCQRS();
    }
    ...
    protected static function getCache_AppService($container)
    {
        ...
        $container->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Bwj6FZs0Db', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    protected static function getCache_SystemService($container)
    {
        ...
        return $container->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iJ98Uxe8lr', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getCacheWarmerService($container)
    {
        ...
        }, 2), true, ($container->targetDir.''.'/TyCode_ms_Product_ProductKernelDevDebugContainerDeprecations.log'));
    }
    ...
    protected static function getRouting_LoaderService($container)
    {
        ...
        $a->addLoader(new \Symfony\Component\Routing\Loader\ContainerLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'kernel' => 'TyCode\\ms\\Product\\ProductKernel',
        ]), 'dev'));
        $a->addLoader($c);
    ...
    /**
     * Gets the private '.service_locator.A7khPHK' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected static function get_ServiceLocator_A7khPHKService($container)
    {
        return $container->privates['.service_locator.A7khPHK'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'productFinderByCriteria' => ['privates', 'TyCode\\Product\\Application\\Find\\ProductFinderByCriteria', 'getProductFinderByCriteriaService', false],
        ], [
            'productFinderByCriteria' => 'TyCode\\Product\\Application\\Find\\ProductFinderByCriteria',
        ]);
    }

    /**
     * Gets the private '.service_locator.DkkXGoU' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected static function get_ServiceLocator_DkkXGoUService($container)
    {
        return $container->privates['.service_locator.DkkXGoU'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'productFinderAll' => ['privates', 'TyCode\\Product\\Application\\Find\\ProductFinderAll', 'getProductFinderAllService', false],
        ], [
            'productFinderAll' => 'TyCode\\Product\\Application\\Find\\ProductFinderAll',
        ]);
    }
    ...
    /**
     * Gets the private '.service_locator.Q7HGaBB' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected static function get_ServiceLocator_Q7HGaBBService($container)
    {
        return $container->privates['.service_locator.Q7HGaBB'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'productFinderId' => ['privates', 'TyCode\\Product\\Application\\Find\\ProductFinderId', 'getProductFinderIdService', false],
        ], [
            'productFinderId' => 'TyCode\\Product\\Application\\Find\\ProductFinderId',
        ]);
    }

    /**
     * Gets the private '.service_locator.jVN.nxE' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected static function get_ServiceLocator_JVN_NxEService($container)
    {
        return $container->privates['.service_locator.jVN.nxE'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'productCreator' => ['privates', 'TyCode\\Product\\Application\\Create\\ProductCreator', 'getProductCreatorService', false],
        ], [
            'productCreator' => 'TyCode\\Product\\Application\\Create\\ProductCreator',
        ]);
    }
    ...
    /**
     * Gets the private '.service_locator.zfXXWV3' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected static function get_ServiceLocator_ZfXXWV3Service($container)
    {
        return $container->privates['.service_locator.zfXXWV3'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProduct::__invoke' => ['privates', '.service_locator.Q7HGaBB', 'get_ServiceLocator_Q7HGaBBService', false],
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProductByCriteria::__invoke' => ['privates', '.service_locator.A7khPHK', 'get_ServiceLocator_A7khPHKService', false],
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProductByCriteriaCQRS::__invoke' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProducts::__invoke' => ['privates', '.service_locator.DkkXGoU', 'get_ServiceLocator_DkkXGoUService', false],
            'TyCode\\Product\\Infrastructure\\Web\\Product\\PostProductCreate::__invoke' => ['privates', '.service_locator.jVN.nxE', 'get_ServiceLocator_JVN_NxEService', false],
            'TyCode\\Product\\Infrastructure\\Web\\Product\\PostProductCreateCQRS::__invoke' => ['privates', '.service_locator.lwNoDbx', 'get_ServiceLocator_LwNoDbxService', false],
            ...
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProduct:__invoke' => ['privates', '.service_locator.Q7HGaBB', 'get_ServiceLocator_Q7HGaBBService', false],
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProduct' => ['privates', '.service_locator.Q7HGaBB', 'get_ServiceLocator_Q7HGaBBService', false],
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProductByCriteria:__invoke' => ['privates', '.service_locator.A7khPHK', 'get_ServiceLocator_A7khPHKService', false],
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProductByCriteria' => ['privates', '.service_locator.A7khPHK', 'get_ServiceLocator_A7khPHKService', false],
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProductByCriteriaCQRS:__invoke' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProductByCriteriaCQRS' => ['privates', '.service_locator.EgMTexf', 'get_ServiceLocator_EgMTexfService', false],
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProducts:__invoke' => ['privates', '.service_locator.DkkXGoU', 'get_ServiceLocator_DkkXGoUService', false],
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProducts' => ['privates', '.service_locator.DkkXGoU', 'get_ServiceLocator_DkkXGoUService', false],
            'TyCode\\Product\\Infrastructure\\Web\\Product\\PostProductCreate:__invoke' => ['privates', '.service_locator.jVN.nxE', 'get_ServiceLocator_JVN_NxEService', false],
            'TyCode\\Product\\Infrastructure\\Web\\Product\\PostProductCreate' => ['privates', '.service_locator.jVN.nxE', 'get_ServiceLocator_JVN_NxEService', false],
            'TyCode\\Product\\Infrastructure\\Web\\Product\\PostProductCreateCQRS:__invoke' => ['privates', '.service_locator.lwNoDbx', 'get_ServiceLocator_LwNoDbxService', false],
            'TyCode\\Product\\Infrastructure\\Web\\Product\\PostProductCreateCQRS' => ['privates', '.service_locator.lwNoDbx', 'get_ServiceLocator_LwNoDbxService', false],
            'kernel:loadRoutes' => ['privates', '.service_locator.y4_Zrx.', 'get_ServiceLocator_Y4Zrx_Service', false],
            'kernel:registerContainerConfiguration' => ['privates', '.service_locator.y4_Zrx.', 'get_ServiceLocator_Y4Zrx_Service', false],
        ], [
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProduct::__invoke' => '?',
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProductByCriteria::__invoke' => '?',
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProductByCriteriaCQRS::__invoke' => '?',
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProducts::__invoke' => '?',
            'TyCode\\Product\\Infrastructure\\Web\\Product\\PostProductCreate::__invoke' => '?',
            'TyCode\\Product\\Infrastructure\\Web\\Product\\PostProductCreateCQRS::__invoke' => '?',
            'kernel::loadRoutes' => '?',
            'kernel::registerContainerConfiguration' => '?',
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProduct:__invoke' => '?',
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProduct' => '?',
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProductByCriteria:__invoke' => '?',
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProductByCriteria' => '?',
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProductByCriteriaCQRS:__invoke' => '?',
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProductByCriteriaCQRS' => '?',
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProducts:__invoke' => '?',
            'TyCode\\Product\\Infrastructure\\Web\\Product\\GetProducts' => '?',
            'TyCode\\Product\\Infrastructure\\Web\\Product\\PostProductCreate:__invoke' => '?',
            'TyCode\\Product\\Infrastructure\\Web\\Product\\PostProductCreate' => '?',
            'TyCode\\Product\\Infrastructure\\Web\\Product\\PostProductCreateCQRS:__invoke' => '?',
            'TyCode\\Product\\Infrastructure\\Web\\Product\\PostProductCreateCQRS' => '?',
            'kernel:loadRoutes' => '?',
            'kernel:registerContainerConfiguration' => '?',
        ]);
    }
    ...
    /**
     * Gets the private 'TyCode\Product\Application\CQRS\Create\CreateProductCommandHandler' shared autowired service.
     *
     * @return \TyCode\Product\Application\CQRS\Create\CreateProductCommandHandler
     */
    protected static function getCreateProductCommandHandlerService($container)
    {
        ...
        include_once \dirname(__DIR__, 6).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Product'.\DIRECTORY_SEPARATOR.'Application'.\DIRECTORY_SEPARATOR.'CQRS'.\DIRECTORY_SEPARATOR.'Create'.\DIRECTORY_SEPARATOR.'CreateProductCommandHandler.php';

        return $container->privates['TyCode\\Product\\Application\\CQRS\\Create\\CreateProductCommandHandler'] = new \TyCode\Product\Application\CQRS\Create\CreateProductCommandHandler(($container->privates['TyCode\\Product\\Application\\Create\\ProductCreator'] ?? self::getProductCreatorService($container)));
    }

    /**
     * Gets the private 'TyCode\Product\Application\CQRS\FindByCriteria\FindProductByCriteriaQueryHandler' shared autowired service.
     *
     * @return \TyCode\Product\Application\CQRS\FindByCriteria\FindProductByCriteriaQueryHandler
     */
    protected static function getFindProductByCriteriaQueryHandlerService($container)
    {
        ...
        include_once \dirname(__DIR__, 6).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Product'.\DIRECTORY_SEPARATOR.'Application'.\DIRECTORY_SEPARATOR.'CQRS'.\DIRECTORY_SEPARATOR.'FindByCriteria'.\DIRECTORY_SEPARATOR.'FindProductByCriteriaQueryHandler.php';

        return $container->privates['TyCode\\Product\\Application\\CQRS\\FindByCriteria\\FindProductByCriteriaQueryHandler'] = new \TyCode\Product\Application\CQRS\FindByCriteria\FindProductByCriteriaQueryHandler(($container->privates['TyCode\\Product\\Application\\Find\\ProductFinderByCriteria'] ?? self::getProductFinderByCriteriaService($container)));
    }

    /**
     * Gets the private 'TyCode\Product\Application\Create\ProductCreator' shared autowired service.
     *
     * @return \TyCode\Product\Application\Create\ProductCreator
     */
    protected static function getProductCreatorService($container)
    {
        include_once \dirname(__DIR__, 6).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Product'.\DIRECTORY_SEPARATOR.'Application'.\DIRECTORY_SEPARATOR.'Create'.\DIRECTORY_SEPARATOR.'ProductCreator.php';

        return $container->privates['TyCode\\Product\\Application\\Create\\ProductCreator'] = new \TyCode\Product\Application\Create\ProductCreator(($container->privates['TyCode\\Product\\Infrastructure\\Persistence\\DoctrineProductRepository'] ?? self::getDoctrineProductRepositoryService($container)));
    }

    /**
     * Gets the private 'TyCode\Product\Application\Find\ProductFinderAll' shared autowired service.
     *
     * @return \TyCode\Product\Application\Find\ProductFinderAll
     */
    protected static function getProductFinderAllService($container)
    {
        include_once \dirname(__DIR__, 6).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Product'.\DIRECTORY_SEPARATOR.'Application'.\DIRECTORY_SEPARATOR.'Find'.\DIRECTORY_SEPARATOR.'ProductFinderAll.php';

        return $container->privates['TyCode\\Product\\Application\\Find\\ProductFinderAll'] = new \TyCode\Product\Application\Find\ProductFinderAll(($container->privates['TyCode\\Product\\Infrastructure\\Persistence\\DoctrineProductRepository'] ?? self::getDoctrineProductRepositoryService($container)));
    }

    /**
     * Gets the private 'TyCode\Product\Application\Find\ProductFinderByCriteria' shared autowired service.
     *
     * @return \TyCode\Product\Application\Find\ProductFinderByCriteria
     */
    protected static function getProductFinderByCriteriaService($container)
    {
        include_once \dirname(__DIR__, 6).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Product'.\DIRECTORY_SEPARATOR.'Application'.\DIRECTORY_SEPARATOR.'Find'.\DIRECTORY_SEPARATOR.'ProductFinderByCriteria.php';

        return $container->privates['TyCode\\Product\\Application\\Find\\ProductFinderByCriteria'] = new \TyCode\Product\Application\Find\ProductFinderByCriteria(($container->privates['TyCode\\Product\\Infrastructure\\Persistence\\DoctrineProductRepository'] ?? self::getDoctrineProductRepositoryService($container)));
    }

    /**
     * Gets the private 'TyCode\Product\Application\Find\ProductFinderId' shared autowired service.
     *
     * @return \TyCode\Product\Application\Find\ProductFinderId
     */
    protected static function getProductFinderIdService($container)
    {
        include_once \dirname(__DIR__, 6).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Product'.\DIRECTORY_SEPARATOR.'Application'.\DIRECTORY_SEPARATOR.'Find'.\DIRECTORY_SEPARATOR.'ProductFinderId.php';

        return $container->privates['TyCode\\Product\\Application\\Find\\ProductFinderId'] = new \TyCode\Product\Application\Find\ProductFinderId(($container->privates['TyCode\\Product\\Infrastructure\\Persistence\\DoctrineProductRepository'] ?? self::getDoctrineProductRepositoryService($container)));
    }

    /**
     * Gets the private 'TyCode\Product\Infrastructure\Persistence\DoctrineProductRepository' shared autowired service.
     *
     * @return \TyCode\Product\Infrastructure\Persistence\DoctrineProductRepository
     */
    protected static function getDoctrineProductRepositoryService($container)
    {
        include_once \dirname(__DIR__, 6).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Product'.\DIRECTORY_SEPARATOR.'Domain'.\DIRECTORY_SEPARATOR.'Product'.\DIRECTORY_SEPARATOR.'ProductRepository.php';
        include_once \dirname(__DIR__, 6).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Product'.\DIRECTORY_SEPARATOR.'Infrastructure'.\DIRECTORY_SEPARATOR.'Persistence'.\DIRECTORY_SEPARATOR.'DoctrineProductRepository.php';

        return $container->privates['TyCode\\Product\\Infrastructure\\Persistence\\DoctrineProductRepository'] = new \TyCode\Product\Infrastructure\Persistence\DoctrineProductRepository(($container->services['Doctrine\\ORM\\EntityManager'] ?? self::getEntityManagerService($container)));
    }
    ...
    protected static function getSymfonyMessageCommandBusService($container)
    {
        ...
        return $container->privates['TyCode\\Shared\\Infrastructure\\Bus\\Command\\SymfonyMessageCommandBus'] = new \TyCode\Shared\Infrastructure\Bus\Command\SymfonyMessageCommandBus(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['TyCode\\Product\\Application\\CQRS\\Create\\CreateProductCommandHandler'] ?? self::getCreateProductCommandHandlerService($container));
        }, 1));
    }
    ...
    protected static function getSymfonyMessageQueryBusService($container)
    {
        ...
        return $container->privates['TyCode\\Shared\\Infrastructure\\Bus\\Query\\SymfonyMessageQueryBus'] = new \TyCode\Shared\Infrastructure\Bus\Query\SymfonyMessageQueryBus(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['TyCode\\Product\\Application\\CQRS\\FindByCriteria\\FindProductByCriteriaQueryHandler'] ?? self::getFindProductByCriteriaQueryHandlerService($container));
        }, 1));
    }
    ...
    protected static function getCache_Messenger_RestartWorkersSignalService($container)
    {
        ...
        $container->privates['cache.messenger.restart_workers_signal'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('JgVhW5vCoP', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/TyCode_ms_Product_ProductKernelDevDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'TyCode_ms_Product_ProductKernelDevDebugContainer',
