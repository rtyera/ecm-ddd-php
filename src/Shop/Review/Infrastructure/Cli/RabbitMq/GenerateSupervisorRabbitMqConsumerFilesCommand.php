...
namespace TyCode\Shop\Review\Infrastructure\Cli\RabbitMq;
...
final class GenerateSupervisorRabbitMqConsumerFilesCommand extends Command
{
    ...
    protected static $defaultName = 'ecm:rabbitmq:events:generate-supervisor-files';
    ...
    private function template(): string
    {
        return <<<EOF
            ...
            command      = {path}/ms/Shop/bin/console ecm:rabbitmq:events:consume --env=prod {queue_name} {events_to_process}
